...
if(isset($_GET['button']) == "btn_add"){
    $id = $_GET['id'];
    $query = "UPDATE `tb_order` SET `order_status`= 4 WHERE `bill_id`= '".$id."' ";
    $update_status=mysqli_query($con,$query);
    if ($update_status){
        header("Refresh:0; url=order-buy3.php");
        exit();
    }
        ...
        <?php include "include/navigationtop.php" ; ?>
          ...
          <div class="right_col" role="main">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>ลูกค้าสั่งอาหาร <small>Users</small></h2>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($order_status == 3){ echo "เสิร์ฟอาหารแล้ว"; } ; ?>
                          </td>
                          <td>
            ...
            echo "โต๊ะ " . $table_id ;
                          ...
                          <td>
                            <a href="report_bill.php?id=<?php echo $bill_id ?>">
                              <button type="button" id="btn_add" class="btn btn-success ">ออกใบเสร็จ</button>
                            </a>
                            <a href="order-buy3.php?button=btn_add&id=<?php echo $bill_id ?>">
                              <button type="button" id="btn_add" class="btn btn-primary ">ชำระเงินแล้ว</button>
                            </a>
                            <a href="order-buy3.php?button=btn_delete&id=<?php echo $bill_id ?>">
