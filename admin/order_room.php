          ...
          <div class="right_col" role="main">
            <div class="">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Order_Room <small>รายการจองของห้อง</small></h2>
...
$query = "SELECT tb_orderroom.room_id,tb_orderroom.bill_id,tb_orderroom.room_date,tb_customer.customer_name FROM `tb_orderroom` LEFT JOIN tb_customer ON tb_orderroom.customer_id = tb_customer.customer_id";
...
if ($result = mysqli_query($con, $query)) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $room_id = $row['room_id'];
        $bill_id = $row['bill_id'];
        $room_date = date("d-m-Y", strtotime($row['room_date']));
        ...
        ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="order_room_edit.php?id=<?php echo $bill_id ; ?>">
                                <button type="button" id="btn_add" class="btn btn-primary ">แก้ไข</button>
                              </a>
                              <a href="order_room_delete.php?id=<?php echo $bill_id ; ?>">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="selectpicker form-control" placeholder="กรุณากรอกหมายเลขห้อง" id="room_id">
                      <?php
while($row_raw = mysqli_fetch_assoc($result_table)) {
    ...
    ?>
                        <option <?php if($room_status==0 || $room_status==2 ){ echo "disabled class='grey_color' " ; } ?> value="
                          <?php echo $room_id ; ?>" >
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" id="room_date" required class="form-control" />
                  </div>

                  <div class="form-group">
                    <label for="room_user">สมาชิกที่จอง :</label>
                    <input type="text" id="room_user" required placeholder="กรุณากรอกรหัสสมาชิกที่ทำการจอง" class="form-control" />
                  </div>
      ...
      <script>
        $(function() {
          $("#frm").submit(function(event) {
            ...
            var room_user = $("#room_user").val();

            $.post("order_room_add.php", {
              room_id: room_id,
              room_date: room_date,
              room_user: room_user
            }).done(function(data) {
