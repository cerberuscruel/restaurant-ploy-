...
<button class="btn btn-default" type="button">Go!</button>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Customer <small>Users</small></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>E-Mail</th>
                          <th width="20%">เบอร์โทรศัพท์ลูกค้า</th>
                          <th width="30%">รหัสเข้าใช้งาน</th>
                          <th></th>
                        </tr>
                      </thead>
                      <tbody>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="customer-edit.php?id=<?php echo $ctmid ; ?>">
                                <button type="button" id="btn_add" class="btn btn-primary ">แก้ไข</button>
                              </a>
                              <a href="customer-delete.php?id=<?php echo $ctmid ; ?>">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <label for="cid">รหัสประจำตัวประชาชน :</label>
                  <input type="text" id="cid" pattern="[0-9]{13}" title="Ex.1348893456312" required placeholder="กรุณากรอกรหัสประจำตัวประชาชน" class="form-control" />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="email" id="Email" required placeholder="กรุณากรอกชื่อของท่าน" class="form-control"></input>
                </div>
